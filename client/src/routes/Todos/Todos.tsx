...
import { Todo } from "src/modules/todo/types";
import { addTodo, removeTodo, updateTodo } from "src/modules/todo/action";
import { selectTodos } from "src/modules/todo/selector";
...
const Todos: React.FC<Props> = ({ todos, addTodo, removeTodo, updateTodo }) => {
